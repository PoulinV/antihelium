...
/*
* Coefficient de diffusion spatiale ˆ la Strong & al, ApJ 509, 212, 1998.
* Il est exprimŽ en [cm^{2} s^{-1}].
*/
...
double b_energy_losses(double energy,double mass,double Z_em, struct Structure_Propagation* pt_Propagation)
{
  ...
  double dE_dt;
/*
* La perte d'Žnergie dE_dt est exprimŽe en [GeV sec^{-1}].
*/
  momentum      = sqrt(pow(energy,2) - pow(mass,2)); /* [GeV]        */
  beta          = momentum / energy;                 /* NO DIMENSION */
...
* ***********************
* L'Žnergie maximale transfŽrŽe est notŽe Q_max et est exprimŽe en [GeV].
*/
...
*/
  ...
  B2 -= 2. * pow(beta,2.);
/*
* La perte d'Žnergie par ionisation est exprimŽe en [GeV s^{-1}].
*/
  ionisation =
...
* **********************
*
* ATTENTION ! Pour pouvoir Žcrire ce terme sous une forme exactement similaire
* aux pertes prŽcŽdentes, il faut factoriser le terme 2h, d'o un terme
* \beq
